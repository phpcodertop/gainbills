                    ...
                    <div class="tab-content" id="permissions">
                        ...
                        <div class="tab-pane" id="<?php echo $gid; ?>">
                            ...
                            <label class="checkbox inline">
							 ...
							 <label class="checkbox inline">
                                <input type="checkbox" id="group_articles_publishing" value="1" <?php if (isset($group['group_articles_publishing']) && (int)$group['group_articles_publishing'] == 1){ ?> checked="checked" <?php } ?> /> <?php echo $this->lang->line('group_articles_publishing'); ?>
                            </label>
                            <br/>
                            <br/>
    ...
    $(document).ready(function(){
        ...
        $('#btn_save').click(function(){
            ...
            $('#permissions > div').each(function(){
				...
				obj.group_articles_publishing = 0;
                obj.coms = [];
				...
				if ($(this).find('input[id="group_articles_publishing"]:checked').val() == '1'){
                    obj.group_articles_publishing = 1;
                }
